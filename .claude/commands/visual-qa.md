...
3. Exercise relevant routes at 360, 390, 430, 768, 1024, 1280, and 1440 pixels. Cover StudyShark/devShark, light/dark, and reduced motion where the target applies. Use `node scripts/check-responsive.mjs` for its automated overflow probes and browser screenshots/inspection for interaction states.
