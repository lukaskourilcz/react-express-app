...
//
// The card logo is a bundled devicon for Web Dev and a subject-specific SVG
// glyph elsewhere. Fin choreography is assigned per card so no two cards
// surface the same school (see FIN_SCHOOLS).
...
// Helper to keep the per-subject tables terse while assigning a distinct fin
// school by position.
const t = (
  i: number,
  id: string,
  ...
  levels: string[],
  question: LandingQuestion,
): LandingTopic => ({ id, name, blurb, levels, question, fins: school(i) });

// ─────────────────────────── Geography (geoShark) ─────────────────────────
const GEOGRAPHY: LandingTopic[] = [
  t(0, 'continents', 'Continents', 'The seven continents and five oceans, and where they meet.',
  ...
  t(1, 'capitals', 'Capitals', 'Countries and their capital cities, region by region.',
  ...
  t(3, 'landforms', 'Landforms', 'Mountains, rivers, deserts, valleys and coasts.',
  ...
  t(4, 'climate', 'Climate', 'Climate zones, biomes, and the water cycle.',
...
const HISTORY: LandingTopic[] = [
  ...
  t(2, 'classical', 'Classical', 'Greece, Rome, and the Hellenistic world.',
...
const CHESS: LandingTopic[] = [
  ...
  t(1, 'tactics', 'Tactics', 'Forks, pins, skewers, and discovered attacks.',
...
const BIOLOGY: LandingTopic[] = [
  ...
  t(4, 'endocrine-system', 'Endocrine', 'Hormones and glands that regulate the body.',
  ...
  t(5, 'cardiovascular-system', 'Cardiovascular', 'Blood, the heart, vessels and circulation.',
