// The StudyShark cosmetic shop: avatar rings and title flairs bought with the
// device-local token wallet. Unchanged behaviour, moved here when devShark's
// shop became server-owned merchandise (issue #169) — StudyShark keeps what it
// had, and `Shop.tsx` picks between the two by product.
//
// Currency = tokens (separate from XP), earned passively as 10% of every XP gain
// plus a one-time 200-token sign-up bonus. Purchases are cosmetic and never
