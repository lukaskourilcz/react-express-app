...
export const en = {
  ...
  'home.step1Text': 'Create a free account — your progress, XP, and streaks sync across devices.',
  'home.step2Title': 'Choose your path',
  'home.step2Text': 'Pick Frontend, Backend or Fullstack — the first lessons unlock instantly.',
  'home.step3Title': 'Start learning',
  'home.step3Text': 'Climb the roadmap, take quizzes, and rank up from Superjunior to Architect.',
