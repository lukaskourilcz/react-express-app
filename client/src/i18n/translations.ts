...
export const en = {
  ...
  'roadmapPage.treeTitle': 'The full roadmap',
  'roadmapPage.treeIntro': 'Every topic, split into 3 short parts and arranged by what builds on what. Your progress fills in as you clear each part.',
