...
export const en = {
  ...
  'title.home': 'devShark — web dev quiz & learning paths',
  ...
  'quiz.tip1': 'Stuck on an answer? Try MDN before you ask an AI — the habit of reading docs is the skill.',
  'quiz.tip2': 'Say the answer out loud before you tap. If you can\'t explain why, that\'s the one to review.',
  'quiz.tip3': 'Wrong answers teach more than right ones. Read the explanation carefully — that\'s the point.',
  ...
  'careerRoadmap.honestyBody': 'senior full-stack is typically 5–8+ years of shipping real software. Knowledge is necessary but not sufficient — you also need the “Beyond devShark” list below, which no quiz app can hand you. devShark gets your fundamentals genuinely solid; the rest is reps in the real world.',
  ...
  'careerRoadmap.xpToSenior': '{xp} XP to devShark’s “Senior Developer” rank (a knowledge proxy, not a job title — yet).',
  ...
  'careerRoadmap.area.javascript.blurb': 'The language of the web — closures, async, the event loop.',
  ...
  'careerRoadmap.area.testing.blurb': 'Unit, integration and end-to-end — and what to test.',
