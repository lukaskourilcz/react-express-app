...
export const cs: Record<TranslationKey, string> = {
  ...
  'home.step1Text': 'Vytvoř si účet zdarma — tvůj postup, XP a série se synchronizují napříč zařízeními.',
  'home.step2Title': 'Vyber si směr',
  'home.step2Text': 'Zvol si Frontend, Backend nebo Fullstack — první lekce se odemknou okamžitě.',
  'home.step3Title': 'Začni se učit',
  'home.step3Text': 'Stoupej po roadmapě, plň kvízy a postupuj od Superjuniora až po Architekta.',
  ...
  'careerRoadmap.headerBody': 'Upřímná mapa toho, co obnáší prosadit se jako seniorní fullstack inženýr — a kam přesně tě devShark dokáže dovést. Bez přehánění: cesta níže je znalostní základ, ne cílová páska.',
  'careerRoadmap.honestyLead': 'Na rovinu:',
  'careerRoadmap.honestyBody': 'seniorní fullstack obvykle znamená 5–8+ let dodávání skutečného softwaru. Znalosti jsou nutné, ale nestačí — potřebuješ i seznam „Nad rámec devSharku“ níže, který ti žádná kvízová aplikace nedá. devShark ti pořádně upevní základy; zbytek jsou zkušenosti z reálného světa.',
  ...
  'careerRoadmap.xpToSenior': '{xp} XP do úrovně „Senior Developer“ v devSharku (ukazatel znalostí, ne pracovní pozice — zatím).',
