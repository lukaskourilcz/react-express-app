...
export const cs: Record<TranslationKey, string> = {
  ...
  'roadmapPage.treeTitle': 'Celá roadmapa',
  'roadmapPage.treeIntro': 'Každé téma rozdělené na 3 krátké části a uspořádané podle toho, co na čem staví. Tvůj progress se vyplňuje, jak jednotlivé části plníš.',
