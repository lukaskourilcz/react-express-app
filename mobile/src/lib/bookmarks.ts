// Local question bookmarks — ported from client/src/lib/bookmarks.ts. A quick
// membership map plus the full saved-question list, capped and stored locally.
...
export const isBookmarked = (id: string): boolean => Boolean(readIds()[id]);
...
/** Live view of bookmarks: `ids` for membership checks, `questions` for the list. */
