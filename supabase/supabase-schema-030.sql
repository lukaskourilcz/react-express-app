-- Migration 030: the auditable reward wallet, the shared order model and the
...
BEGIN
  ...
  -- The learning paths of migration 026. This function is redefined here, so
  -- every table any earlier migration added has to be named again or erasure
  -- quietly stops reaching it.
